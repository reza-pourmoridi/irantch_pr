...
<html><body><a class="__login_register__ main-navigation__button2 show-box-login-js button_header logIn d-flex d-lg-none" href="javascript:"><i>
...
</i><span>{include file="`$smarty.const.FRONT_CURRENT_THEME`topBarName.tpl"}</span></a>
...
<li><a href="javascript:">فایل های راهنما</a></li>
</ul>
</li>
<li class="d-none d-lg-flex"><a class="__login_register__2 main-navigation__button2 show-box-login-js" href="javascript:" st="">{include file="`$smarty.const.FRONT_CURRENT_THEME`topBarName.tpl"}</a></li>
</ul>
</div>
</nav>
</div>
