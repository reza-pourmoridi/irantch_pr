...
<html><body><p>{if $othe_itmes[0] }
</p><div class="__i_modular_c_item_0 div2">
...
{/if}</body></html>
<html><body><p>{if $othe_itmes[1] }
</p><div class="__i_modular_c_item_1 div3">
...
{/if}</body></html>
<html><body><p>{if $othe_itmes[2] }
</p><div class="__i_modular_c_item_2 div4">
...
{/if}</body></html>
<html><body><p>{if $othe_itmes[3] }
</p><div class="__i_modular_c_item_3 div5">
