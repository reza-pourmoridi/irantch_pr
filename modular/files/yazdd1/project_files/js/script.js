$(document).ready(function () {
    ...
    $('.tour-dakheli-crousel').owlCarousel({
        items:3,
        center: true,
        rtl:true,
        loop:true,
    ...
    $('.tour-vijhe-crousel').owlCarousel({
        items:3,
        rtl:true,
        center: true,
        margin:15,
    ...
    $('.tour-khareji-crousel').owlCarousel({
        items:3,
        rtl:true,
        loop:true,
        center: true,
...
$(window).on('load', function(){
    ...
    setTimeout(addclassafterload, 3000); //wait for page load PLUS two seconds.
});
function removeLoader() {
    $(".load-container").fadeOut(500, function () {
// fadeOut complete. Remove the loading div
        $(".load-container").remove(); //makes page more lightweight
    });
    $(".home-searchbox").addClass('loaded');
...
function js_height_init() {
    (function($) {
        ...
        var height = heights - 75;
        $(".home-searchbox").height(height);
    })(jQuery);
}
