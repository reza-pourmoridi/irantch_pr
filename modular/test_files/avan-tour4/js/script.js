...
$(document).ready(function () {
    ...
    $(".fixicone-whatsapp , .fixicone-telegram").addClass('d-none');
    // fade in #back-top
    $(function () {
        $(window).scroll(function () {
            if ($(this).scrollTop() > 100) {
                $('.fixicone-whatsapp , .fixicone-telegram').addClass('d-flex');
                $('.fixicone-whatsapp , .fixicone-telegram').removeClass('d-none');
            } else {
                $('.fixicone-whatsapp , .fixicone-telegram').removeClass('d-flex');
                $('.fixicone-whatsapp , .fixicone-telegram').addClass('d-none');
            }
        });
    });
        ...
        if($(window).width() > 992){
            ...
            $(window).scroll(function() {
                if ($(this).scrollTop() > 200) {
                    $('.bg-parent-div-logo-meda').addClass('fixedmenu');
                } else {
                    $('.bg-parent-div-logo-meda').removeClass('fixedmenu');
                }
            });
